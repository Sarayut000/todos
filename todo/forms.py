...
class UpdateAccountForm(FlaskForm):
  ...
  fullname = StringField(label='Fullname', render_kw={'placeholder': 'Enter your Fullname'})
  avatar = FileField(label='Update Profile Avatar', validators=[FileAllowed(['jpg', 'png', 'jpeg'])])
